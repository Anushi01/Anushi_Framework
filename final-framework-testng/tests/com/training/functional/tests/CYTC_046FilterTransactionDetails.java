...
public class CYTC_046FilterTransactionDetails {
	...
	public void validLoginTest() throws InterruptedException {
		...
		btnPOM.advanceButton();
		loginPOM.sendMemUserName("Selenium01");
		btnPOM.searchButton();
		Thread.sleep(2000);
		memlogPOM.FromDateButton();
		Thread.sleep(1000);
		memlogPOM.ToDateButton();
		btnPOM.searchButton();
		memlogPOM.PaymentFilter();
		btnPOM.searchButton();
		String actual = memlogPOM.confirmtext_TC046();
